...
export const TOOL_CONFIGS: ToolConfig[] = [
  {
    ...
    semanticContext:
      "time queries, what time is it, current time, current date, time right now, what day is today, clock time, date information, timestamp queries, time zone, current moment time checking, NOT web search, NOT document analysis, NOT weather information, NOT news search, NOT content analysis, ONLY time and date queries",
    triggers: [
      "time",
      "date",
      "current",
  ...
  },
  {
    ...
    semanticContext:
      "web search, internet search, latest news, breaking news, current events, search for information, find information online, news updates, web information, online research, search query, information lookup, biographical queries, factual information, NOT document analysis, NOT personal files, NOT time queries, NOT weather queries, ONLY web search and news",
    triggers: [
      "search",
      "news",
      "latest",
  ...
  },
  {
    ...
    usageExamples: [
      ...
      "YouTube content about",
      "videos explaining",
      "tutorial videos for",
      "educational videos about",
      "find YouTube channels about",
      "video content about",
    ],
    semanticContext:
      "YouTube search, video content, video tutorials, educational videos, video explanations, video content search, YouTube channels, video recommendations, video analysis, video information, video metadata, video descriptions, video titles, video channels, NOT web search, NOT document analysis, NOT time queries, NOT weather queries, ONLY YouTube video search",
    triggers: [
      "youtube",
      "video",
      "videos",
    ...
    langchainDescription:
      'Use this tool when the user asks to search for YouTube videos, find video content, or look for video tutorials. This tool searches YouTube for videos matching the query and provides video information including titles, channels, descriptions, and URLs. Input should be a search query for video content (e.g., "Python tutorials", "cooking recipes", "tech reviews").',
  },
  {
...
export const TOOL_CATEGORIES = {
  ...
  WEB_RESEARCH: {
    name: "WEB_RESEARCH",
    description:
      "Internet search, news, factual information, biographical data",
    tools: ["tavilySearch", "youtubeSearch"],
    examples: [
      "latest news",
      "age of person",
      "search information",
